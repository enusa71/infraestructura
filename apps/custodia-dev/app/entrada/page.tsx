...
export default function EntradaPage() {
  ...
  const handleCapturarFirmaAuxiliar = async () => {
    ...
    try {
      // Extract base64 string from signature object
      const firmaBase64 = typeof firmaAuxiliarCaptura === 'object'
        ? (firmaAuxiliarCaptura as any).base64
    ...
    if (paso === 1) {
      ...
      try {
        const result = await crearCustodia(
          ...
          puerta,
          placa || null,
          typeof firmaIngreso === 'object' ? firmaIngreso?.base64 : firmaIngreso,
          typeof firmaGuardia === 'object' ? firmaGuardia?.base64 : firmaGuardia,
          auxiliar?.nombre,
          auxiliar?.cedula
        );
  ...
  return (
    <ProtectorPerfilAuxiliar>
      <>
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-1">Entrada de Herramientas</h1>
          <p className="text-gray-600">Registro de entrada de herramientas y equipos</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 md:p-8">
          ...
          {necesitaCapturar && (
            <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg mb-6">
              <p className="text-amber-900 font-semibold mb-2">📝 Primera vez en el sistema</p>
              <p className="text-sm text-amber-800">Debes capturar tu firma. Esta será usada en todas tus operaciones futuras.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            {necesitaCapturar && paso === 0 && (
              <div className="space-y-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Captura tu Firma</h2>
            ...
            {paso === 1 && (
              <div className="space-y-5 md:space-y-4">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Datos de Entrada</h2>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-2">Zona Franca</label>
                    <select
                      value={zonaFranca}
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-2">Puerta</label>
                    <select
                      value={puerta}
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Cédula</label>
                  <input
                    type="text"
                    value={cedula}
            ...
            {paso === 2 && (
              <div className="space-y-4">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Herramientas a Ingresar</h2>
                      ...
                      <div className="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-20 px-3 py-2 border border-gray-300 rounded-lg text-gray-900 text-center text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          />
                        </div>
                      </div>
                  ...
                  {pestaña === 'crear' && (
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg mb-3 text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        autoComplete="off"
                        autoFocus
                      />
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg mb-4 text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        rows={2}
                      />
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-2 bg-gray-400 text-white text-sm font-semibold rounded-lg hover:bg-gray-500 transition-colors"
                        >
                          Cancelar
                        </button>
                      </div>
                      ...
                      {items.map((item, idx) => (
                        ...
                        >
                          ...
                          <div className="flex gap-2 items-end">
                            <div>
                              <label className="block text-xs font-semibold text-gray-900 mb-1">Cantidad</label>
                              <input
                                type="number"
                                min="1"
                                value={item.cantidad}
                                ...
                                className="w-16 px-2 py-1 border border-gray-300 rounded-lg text-gray-900 text-center text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              />
                            </div>
                            <button
                              type="button"
            ...
            {paso === 3 && (
              <div className="space-y-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Revisión y Firma</h2>
            ...
            {necesitaCapturar && paso === 0 ? (
              <div className="flex gap-3 mt-8">
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-sm"
                >
              ...
              <div className="flex gap-3 mt-8">
                {paso > 1 && (
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-gray-200 text-gray-900 font-semibold rounded-lg hover:bg-gray-300 text-sm"
                  >
                    ← Atrás
                  </button>
                )}
                <button
                  type="submit"
                  disabled={guardando}
                  className="flex-1 px-4 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-sm"
                >
